...
#define MAGIC_PSU_POLL_SERIAL 0x41
#define MAGIC_PSU_SET_VOLTAGE 0x42
#define MAGIC_PSU_POLL_AC_STATUS 0x23
#define MAGIC_PSU_SET_OUTPUT 0x29
#define MAGIC_PSU_POLL_OUTPUT 0x24
#define MAGIC_PSU_POLL_AC_PARAMETERS 0x46
